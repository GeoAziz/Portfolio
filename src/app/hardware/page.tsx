...
export default function HardwarePage() {
  ...
  return (
    <MotionFade>
      <div data-testid="hardware-page" className="space-y-16">
        <div data-testid="hardware-header" className="text-center max-w-4xl mx-auto">
            <h1 data-testid="hardware-title" className="font-headline text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-foreground flex items-center justify-center gap-4">
                <HardDrive className="w-10 h-10 text-accent-hardware" /> Hardware Engineering
            </h1>
            <p data-testid="hardware-description" className="mt-4 text-lg md:text-xl text-muted-foreground">
                From microcontrollers to sensors, circuits & real-world robotics.
            </p>
        </div>

        <section data-testid="hardware-projects">
          ...
          <div className="mt-8">
            ...
            >
              {(filteredProjects) => (
                <div data-testid="hardware-projects-grid" className="grid gap-6 md:gap-8 mt-6">
        ...
        <section data-testid="hardware-inventory">
          <SectionHeader title="Component Inventory" />
            <Card className="bg-card border-border mt-8">
                <CardContent data-testid="hardware-components" className="p-6">
